    ...
    for read_pair in paired_end_reads:
        ...
        for read in read_pair:
            ...
            for i in range(len(ref) - l):
                ...
                if n_mismatches < min(4, min_mismatches):
            ...
            if min_mismatches < 4:
                ...
                break
            # # Original : Note that there are some huge potential problems here.
